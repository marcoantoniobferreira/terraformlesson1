...
resource "azurerm_resource_group" "infracloudlesson" {
  name     = "infracloudlesson"
  location = "eastus"
}

resource "azurerm_virtual_network" "vnet" {
  name                = "vnet"
  location            = azurerm_resource_group.infracloudlesson.location
  resource_group_name = azurerm_resource_group.infracloudlesson.name
